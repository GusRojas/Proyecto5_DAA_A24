...
def draw_graph(grafo, positions, width=800, height=600, delay=10, iterations_per_frame=10):
    ...
    pygame.display.set_caption("Grafo - Malla 500")
    ...
    with imageio.get_writer('Malla500.mp4', fps=10) as writer:
...
if __name__ == "__main__":
    ...
    draw_graph(grafo, positions, width, height, delay=10, iterations_per_frame=20)